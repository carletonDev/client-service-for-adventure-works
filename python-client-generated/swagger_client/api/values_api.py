...
class ValuesApi(object):
    ...
    def get_0(self, id, **kwargs):  # noqa: E501
        """get_0  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_0(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_0_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_0_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_0_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_0  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_0_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_0`")  # noqa: E501
